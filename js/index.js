  ...
  //WHY ISNT THIS WORKING ADD CLASS ????
  css($("li").last().addClass("favorite");
...
******corrected: forgot the () to call updateCount function.
#################################################*/
...
a heart icon)"
  ...
  >>>>>>>>>>Attempted Correction: method addClass() not functioning as expected On lINE 29 
